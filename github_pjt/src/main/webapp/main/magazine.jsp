    ...
    <div class="container">
        ...
        <% while (rs.next()) { %>
            <div class="row magazine-container">
                <div class="col-md-5">
                    <img src="../resources/img/<%=rs.getString("MAGAZINEID")%>.jpg" class="magazine-img">
                </div>
                <div class="col-md-7">
                    <h3 class="magazine-title"><%=rs.getString("magTitle")%></h3>
                    <p class="magazine-tag"><b>SubTitle:</b> <%=rs.getString("magTag")%></p>
                    <p class="magazine-author"><b>Author:</b> <%=rs.getString("clientId")%></p>
                    <pre class="magazine-content"><b>Content:</b> <%=rs.getString("magContent")%></pre>
                </div>
            </div>
        <% } %>
                ...
                <% while (rs.next()) { %>
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <p class="card-text"><small class="text-muted"><%= rs.getTimestamp("CREATED_AT") %></small></p>
                        </div>
                    </div>
                <% } %>
            </div>
