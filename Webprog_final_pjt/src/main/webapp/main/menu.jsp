...
<body>
	...
	<fmt:bundle basename="bundle.message">
		...
		<div class="Headerblock">
			<div class="item1">
				<a href="../main/main.jsp"><img
					src="../resources/img/Dongjunlog.png"></a> <a href="?language=ko">Korean</a>
				...
				<div class="Header-button">
					...
					<div class="d-flex gap-2">
						...
						<form action="../add/addMagazine.jsp" method="post">
							<button type="submit" class="btn btn-dark">
								<fmt:message key="cre_art" />
							</button>
						</form>
						<form action="../checkMyMag/checkMag.jsp" method="post">
							<button type="submit" class="btn btn-dark">
								<fmt:message key="art_list" />
							</button>
						</form>
					</div>
					<%
		...
		<div class="container mt-3">
			<form name="search" action="../search/search_process.jsp"
				method="post" class="d-flex" onsubmit="return checkSearch()">
				<input class="form-control me-2" type="search" placeholder="Search"
					aria-label="Search" name="search_value">
